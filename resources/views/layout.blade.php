    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand active" href="/">Artisan</a>
            </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                @guest
                    ...
                    <li><a href="{{ url('register') }}"><span class="glyphicon glyphicon-user"></span>Worker Register</a></li>
                    <li><a href="{{ url('login')}}"><span class="glyphicon glyphicon-log-in"></span>Worker Login</a></li> 
                    --}}
                    <li><a href="{{ url('admin/login')}}"><span class="glyphicon glyphicon-log-in"></span>Admin Login</a></li>
